...
object TestUtils {
  ...
  def insertTestTournamentIntoDatabase(implicit session: JdbcBackend#Session) = {
    ...
    session.createStatement().executeUpdate("INSERT INTO rounds VALUES (1, 'round', 'models.round.group.GroupRound', 1, false, 1);")
    ...
    session.createStatement().executeUpdate("INSERT INTO units VALUES (1, 1, 'models.round.group.Group', 'Group K');")
