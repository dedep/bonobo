...
class TournamentImplTest extends FunSuite {
  ...
  test("should not create preliminary round - create group round instead") {
    ...
    val t8 = new Team(8, 8)
    val t9 = new Team(1, 1)
    val t10 = new Team(2, 2)
    val t11 = new Team(3, 3)
    val t12 = new Team(4, 4)
    val t13 = new Team(5, 5)
    val t14 = new Team(6, 6)
    val t15 = new Team(7, 7)
    val t16 = new Team(8, 8)
    val t17 = new Team(1, 1)
    val t18 = new Team(2, 2)
    val t19 = new Team(3, 3)
    val t20 = new Team(4, 4)
    val t21 = new Team(5, 5)
    val t22 = new Team(6, 6)
    val t23 = new Team(7, 7)
    val t24 = new Team(8, 8)
    val t25 = new Team(1, 1)
    val t26 = new Team(2, 2)
    val t27 = new Team(3, 3)
    val t28 = new Team(4, 4)
    val t29 = new Team(5, 5)
    val t30 = new Team(6, 6)
