...
class MatchesTable(tag: Tag) extends Table[(Long, Long, Int, Long, Option[Int], Long, Option[Int])](tag, "matches") {
  ...
  def * = (id, unitId, fixtureNum, aTeamId, aTeamGoals, bTeamId, bTeamGoals)
}
