...
class Pair(override val name: String, teamsCbn: => List[City], fixturesCbn: => List[Fixture] = Nil, resultsCbn: => List[UnitTeamResult] = Nil,
  ...
  def this(name: String, p: (City, City))(r: RoundInfo)(implicit inj: Injector) = {
